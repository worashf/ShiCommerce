...
const UpdateProduct = () => {
    ...
    const { loading, error: updateError, isUpdated } = useSelector(state => state.productAction);
    ...
    useEffect(() => {
        ...
        if (productDetail && productDetail._id !== productId) {
            ...
            setSeller(productDetail.seller);
    ...
    const submitHandler = (e) => {
        ...
        dispatch(updateProduct(productDetail._id, formData))
    }
